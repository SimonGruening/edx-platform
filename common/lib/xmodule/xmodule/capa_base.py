...
from xblock.fields import Scope, String, Boolean, Dict, Integer, Float, JSONField
from .fields import Timedelta, Date, IntegerWithWarningField
...
class CapaFields(object):
    ...
    minutes_before_warning = Integer(
        help=_("Number of minutes at which the student will be issued a timed warning. Works only when minutes_allowed is non-zero"),
...
class CapaMixin(CapaFields):
    ...
    def get_problem_html(self, encapsulate=True):
        ...
        context = {
            ...
            'minutes_before_warning': self.minutes_before_warning,
    ...
    def exceeded_time_limit(self):
        ...
        time_limit_end = self.time_started + datetime.timedelta(minutes=(self.minutes_allowed + 0))
