...
'''
  ...
  describe 'maybeSetupTimer', ->
    ...
    it 'correctly initializes the timer', ->
      ...
      expect(@problem.seconds_left).toEqual(119)
  ...
  describe 'syncTimer', ->
    ...
    it 'should show a warning when showTimerWarning has been reached', ->
      @problem.seconds_left = 59
      @problem.seconds_before_warning = 59
      ...
      waitsFor(=>
        @problem.seconds_left == 58
      , "A second has ticked by", 1000)

      runs(=>
        expect(@problem.syncTimer).toHaveBeenCalled()
        expect(@problem.showTimerWarning).toHaveBeenCalled()
        expect(@problem.seconds_left).toEqual(58)
  ...
  describe 'showTimerWarning', ->
    beforeEach ->
      ...
      content = '''
        ...
        <input id="input_1_2" name="input_1_2" value="two" />
        <input id="input_bogus_3" name="input_bogus_3" value="three" />
        <div class="problem-timer" data-seconds-left="50" data-minutes-before-warning="60">
          You have <span class="minutes-left"></span> minutes left to complete these questions.
        </div>
        <div class="problem">
          Problem Content
    ...
    it 'should show two timer warnings in the html', ->
      @problem.seconds_left = 50
      @problem.seconds_before_warning = 60
      ...
      waitsFor(=>
        @problem.seconds_left == 48
      , "Two seconds have ticked by", 2000)
