...
ANALYTICS_SERVER_URL = ENV_TOKENS.get("ANALYTICS_SERVER_URL", ANALYTICS_SERVER_URL)
...
STUDENT_SUBMISSIONS_DOWNLOAD = ENV_TOKENS.get("STUDENT_SUBMISSIONS_DOWNLOAD", STUDENT_SUBMISSIONS_DOWNLOAD)
